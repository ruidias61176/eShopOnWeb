...
namespace Microsoft.eShopWeb.Web.Areas.Identity.Pages.Account
{
    ...
    public class FacebookOptions : OAuthOptions
    {
        ...
        public override void Validate()
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, nameof(AppId)), nameof(AppId));
            }

            if (string.IsNullOrEmpty(AppSecret))
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, nameof(AppSecret)), nameof(AppSecret));
            }
